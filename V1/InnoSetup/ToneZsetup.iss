...
#define MyAppName "ToneZ"
#define MyAppVersion "1.0.1"
#define MyAppPublisher "T0NIT0 RMX"
#define MyAppURL "https://t0nit0rmx.github.io/"
#define BuildDir "/x64"

;CHANGE THIS !!!
#define MyPluginName "ToneZ"
...
OutputBaseFilename=ToneZ_x64_{#MyAppVersion}_Setup
...
UninstallFilesDir=C:\ProgramData\T0NIT0RMX\{#MyPluginName}\data
DirExistsWarning=no
...
[Files]
Source: "{#BuildDir}\{#MyPluginName}\*"; DestDir: "C:\ProgramData\T0NIT0RMX\{#MyPluginName}\"; Flags: ignoreversion recursesubdirs; Permissions: users-full;
Source: "{#BuildDir}/{#MyPluginName}.dll"; DestDir: "{app}"; Flags: ignoreversion; Permissions: users-full;
Source: "{#BuildDir}/csound64.dll"; DestDir: "C:\Program Files\Csound6_x64\bin"; Flags: ignoreversion; Permissions: users-full;
Source: "Utils\Discord.bmp"; Flags: dontcopy
...
var
  ErrorCode: Integer;
begin
  ShellExec('open', 'https://discordapp.com/invite/JyYqr4q', '', '', SW_SHOWNORMAL, ewNoWait, ErrorCode);
end;
...
begin
  CreateMyImage();
	...
	URLLabel.Caption := ExpandConstant('t0nit0rmx.github.io');
