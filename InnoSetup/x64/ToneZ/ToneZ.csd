...
groupbox bounds(5, 5, 305, 125), , identchannel("GROUP_OSCALL"), plant("GUI_OSCALL"){
    ...
    groupbox bounds(0, 20, 305, 110), visible(1), identchannel("GROUP_OSC1"), plant("GUI_OSC1"){
        ...
        combobox bounds(5, 5, 70, 20), fontcolour("silver") channel("osc1wave1"), items("Saw","Sine","Triangle","Square","Pulse","Buzz","Fizz","Ring","Croon","Plane","Bell","Noise"), value(1), colour(20,30,40), align("centre")
        combobox bounds(76, 5, 70, 20), fontcolour("silver") channel("osc1wave2"), items("Saw","Sine","Triangle","Square","Pulse","Buzz","Fizz","Ring","Croon","Plane","Bell"), value(1), colour(20,30,40), align("centre")
        rslider bounds(55, 5, 20, 20),       channel("osc1wave1"), range(1, 12, 1, 1, 1), $rsliderhiddenstyle
        rslider bounds(119, 5, 35, 20),      channel("osc1wave2"), range(1, 11, 1, 1, 1), $rsliderhiddenstyle
    ...
    groupbox bounds(0, 20, 305, 110), visible(0), identchannel("GROUP_OSC2"), plant("GUI_OSC2"){
        ...
        combobox bounds(5, 5, 70, 20), fontcolour("silver") channel("osc2wave1"), items("Saw","Sine","Triangle","Square","Pulse","Buzz","Fizz","Ring","Croon","Plane","Bell","Noise"), value(1), colour(20,30,40), align("centre")
        combobox bounds(76, 5, 70, 20), fontcolour("silver") channel("osc2wave2"), items("Saw","Sine","Triangle","Square","Pulse","Buzz","Fizz","Ring","Croon","Plane","Bell"), value(1), colour(20,30,40), align("centre")
        rslider bounds(55, 5, 20, 20),       channel("osc2wave1"), range(1, 12, 1, 1, 1), $rsliderhiddenstyle
        rslider bounds(119, 5, 35, 20),      channel("osc2wave2"), range(1, 11, 1, 1, 1), $rsliderhiddenstyle
        label bounds(25, 28, 100, 11), text("Morph")
    ...
    groupbox bounds(0, 20, 305, 110), visible(0), identchannel("GROUP_OSC3"), plant("GUI_OSC3"){
        ...
        combobox bounds(5, 5, 70, 20), fontcolour("silver") channel("osc3wave1"), items("Saw","Sine","Triangle","Square","Pulse","Buzz","Fizz","Ring","Croon","Plane","Bell","Noise"), value(1), colour(20,30,40), align("centre")
        combobox bounds(76, 5, 70, 20), fontcolour("silver") channel("osc3wave2"), items("Saw","Sine","Triangle","Square","Pulse","Buzz","Fizz","Ring","Croon","Plane","Bell"), value(1), colour(20,30,40), align("centre")
        rslider bounds(55, 5, 20, 20),       channel("osc3wave1"), range(1, 12, 1, 1, 1), alpha(0.2), $rsliderhiddenstyle
        rslider bounds(119, 5, 35, 20),      channel("osc3wave2"), range(1, 11, 1, 1, 1), alpha(0.2), $rsliderhiddenstyle
        label bounds(25, 28, 100, 11), text("Morph")
    ...
    groupbox bounds(0, 20, 305, 110), visible(0), identchannel("GROUP_OSC4"), plant("GUI_OSC4"){
        ...
        combobox bounds(5, 5, 70, 20), fontcolour("silver") channel("osc4wave1"), items("Saw","Sine","Triangle","Square","Pulse","Buzz","Fizz","Ring","Croon","Plane","Bell","Noise"), value(1), colour(20,30,40), align("centre")
        combobox bounds(76, 5, 70, 20), fontcolour("silver") channel("osc4wave2"), items("Saw","Sine","Triangle","Square","Pulse","Buzz","Fizz","Ring","Croon","Plane","Bell"), value(1), colour(20,30,40), align("centre")
        rslider bounds(55, 5, 20, 20),       channel("osc4wave1"), range(1, 12, 1, 1, 1), alpha(0.2), $rsliderhiddenstyle
        rslider bounds(119, 5, 35, 20),      channel("osc4wave2"), range(1, 11, 1, 1, 1), alpha(0.2), $rsliderhiddenstyle
        label bounds(25, 28, 100, 11), text("Morph")
...
groupbox bounds(320, 140, 230, 125), , identchannel("GROUP_LFOALL"), plant("GUI_LFOALL"){
    ...
    groupbox bounds(0, 20, 230, 110), visible(1) , identchannel("GROUP_LFO1"), plant("GUI_LFO1"){
        ...
        combobox bounds(5, 64, 70, 20), fontcolour("silver") channel("lfo1shape"), items("-","Sine","Triangle","Square","Saw Dn","Saw Up","Random"), value(1), colour(20,30,40), align("centre")
        rslider  bounds(55, 64, 20, 20),    channel("lfo1shape"),       range(1, 7, 0, 1, 1), $rsliderhiddenstyle
     ...
     groupbox bounds(0, 20, 230, 110), visible(0) , identchannel("GROUP_LFO2"), plant("GUI_LFO2"){
        ...
        combobox bounds(5, 64, 70, 20), fontcolour("silver") channel("lfo2shape"), items("-","Sine","Triangle","Square","Saw Dn","Saw Up","Random"), value(1), colour(20,30,40), align("centre")
        rslider  bounds(55, 64, 20, 20),    channel("lfo2shape"),       range(1, 7, 0, 1, 1), $rsliderhiddenstyle
        label    bounds(13,88,50,11), text("Shape")
...
groupbox bounds(5, 140, 305, 125), , identchannel("GROUP_FILTERALL"), plant("GUI_FILTERALL"){
    ...
    groupbox bounds(0, 20, 305, 125), visible(1) , identchannel("GROUP_FILTER1"), plant("GUI_FILTER1"){
        ...
        combobox bounds(55, 15, 55, 20), fontcolour("silver") channel("filter1mode1"), items("-","LP3","LP2","HP","BP"), value(1), colour(20,30,40), align("centre")
        rslider bounds(83, 15, 35, 20), range(1, 5, 0, 1, 1),              channel("filter1mode1"), $rsliderhiddenstyle
        ...
        combobox bounds(55, 65, 55, 20), fontcolour("silver") channel("filter1mode2"), items("-","LP3","LP2","HP","BP"), value(1), colour(20,30,40), align("centre")
        rslider bounds(83, 65, 35, 20), range(1, 5, 0, 1, 1),             channel("filter1mode2"), $rsliderhiddenstyle
    ...
    groupbox bounds(0, 20, 305, 125), visible(0) , identchannel("GROUP_FILTER2"), plant("GUI_FILTER2"){
        ...
        combobox bounds(55, 15, 55, 20), fontcolour("silver") channel("filter2mode1"), items("-","LP3","LP2","HP","BP"), value(1), colour(20,30,40), align("centre")
        rslider bounds(83, 15, 35, 20), range(1, 5, 0, 1, 1),              channel("filter2mode1"), $rsliderhiddenstyle
        ...
        combobox bounds(55, 65, 55, 20), fontcolour("silver") channel("filter2mode2"), items("-","LP3","LP2","HP","BP"), value(1), colour(20,30,40), align("centre") 
        rslider bounds(83, 65, 35, 20), range(1, 5, 0, 1, 1),             channel("filter2mode2"), $rsliderhiddenstyle
...
groupbox bounds(100, 100, 500, 300), visible(0) , identchannel("GROUP_ABOUT"), plant("GUI_ABOUT"){
    ...
    label    bounds(0,20,500,20), text("ToneZ by T0NIT0 RMX - v1.0.1")
...
instr	UpdateGUI
   ...
   if kTrigEFFECT==1 then
	...
	gkosc1wave1 chnget "osc1wave1"
    gkosc1wave2 chnget "osc1wave2"
    ...
    gkosc2wave1 chnget "osc2wave1"
    gkosc2wave2 chnget "osc2wave2"
    ...
    gkosc3wave1 chnget "osc3wave1"
    gkosc3wave2 chnget "osc3wave2"
    ...
    gkosc4wave1 chnget "osc4wave1"
    gkosc4wave2 chnget "osc4wave2"
    ...
    gkfilter1mode1 chnget "filter1mode1"
    ...
    gkfilter1mode2 chnget "filter1mode2"
    ...
    gkfilter2mode1 chnget "filter2mode1"
    ...
    gkfilter2mode2 chnget "filter2mode2"
...
;*******************************************************************************LEGATO*********************************************	
    ...
    a1l ntrpol a1l*2,a(0),gkosc1pan/100.1
    a1r ntrpol a(0),a1r*2,gkosc1pan/100.1
    ...
    a2l ntrpol a2l*2,a(0),gkosc2pan/100.1
    a2r ntrpol a(0),a2r*2,gkosc2pan/100.1
    ...
    a3l ntrpol a3l*2,a(0),gkosc3pan/100.1
    a3r ntrpol a(0),a3r*2,gkosc3pan/100.1
    ...
    a4l ntrpol a4l*2,a(0),gkosc4pan/100.1
    a4r ntrpol a(0),a4r*2,gkosc4pan/100.1
    rireturn
...
instr 1003 ;save presets
    ...
    fprints gSFileName, "%f %f %f %f %f %f %f %f %f %f %f %f %f ", chnget:i("osc1wave1"), chnget:i("osc1wave2"), chnget:i("osc1morph"), chnget:i("osc1vol"), chnget:i("osc1det"), chnget:i("osc1wid"), chnget:i("osc1phase"), chnget:i("osc1voice"), chnget:i("osc1octave"), chnget:i("osc1semi"), chnget:i("osc1cent"), chnget:i("osc1retrig"), chnget:i("osc1pan")
    fprints gSFileName, "%f %f %f %f %f %f %f %f %f %f %f %f %f ", chnget:i("osc2wave1"), chnget:i("osc2wave2"), chnget:i("osc2morph"), chnget:i("osc2vol"), chnget:i("osc2det"), chnget:i("osc2wid"), chnget:i("osc2phase"), chnget:i("osc2voice"), chnget:i("osc2octave"), chnget:i("osc2semi"), chnget:i("osc2cent"), chnget:i("osc2retrig"), chnget:i("osc2pan")
    fprints gSFileName, "%f %f %f %f %f %f %f %f %f %f %f %f %f ", chnget:i("osc3wave1"), chnget:i("osc3wave2"), chnget:i("osc3morph"), chnget:i("osc3vol"), chnget:i("osc3det"), chnget:i("osc3wid"), chnget:i("osc3phase"), chnget:i("osc3voice"), chnget:i("osc3octave"), chnget:i("osc3semi"), chnget:i("osc3cent"), chnget:i("osc3retrig"), chnget:i("osc3pan")
    fprints gSFileName, "%f %f %f %f %f %f %f %f %f %f %f %f %f ", chnget:i("osc4wave1"), chnget:i("osc4wave2"), chnget:i("osc4morph"), chnget:i("osc4vol"), chnget:i("osc4det"), chnget:i("osc4wid"), chnget:i("osc4phase"), chnget:i("osc4voice"), chnget:i("osc4octave"), chnget:i("osc4semi"), chnget:i("osc4cent"), chnget:i("osc4retrig"), chnget:i("osc4pan")
    ...
    fprints gSFileName, "%f %f %f %f %f %f %f %f %f %f %f ", chnget:i("lfo1shape"), chnget:i("lfo1gain"), chnget:i("lfo1rate"), chnget:i("lfo1amt"), chnget:i("lfo1osc1"), chnget:i("lfo1osc2"), chnget:i("lfo1osc3"), chnget:i("lfo1osc4"), chnget:i("lfo1amp"), chnget:i("lfo1pitch"), chnget:i("lfo1filter")
    fprints gSFileName, "%f %f %f %f %f %f %f %f %f %f %f ", chnget:i("lfo2shape"), chnget:i("lfo2gain"), chnget:i("lfo2rate"), chnget:i("lfo2amt"), chnget:i("lfo2osc1"), chnget:i("lfo2osc2"), chnget:i("lfo2osc3"), chnget:i("lfo2osc4"), chnget:i("lfo2amp"), chnget:i("lfo2pitch"), chnget:i("lfo2filter")
    fprints gSFileName, "%f %f ", chnget:i("LFO1_BUTTON"), chnget:i("LFO2_BUTTON")
    fprints gSFileName, "%f %f %f %f %f %f %f %f %f %f %f %f ", chnget:i("filter1mode1"), chnget:i("filter1cut1"), chnget:i("filter1res1"), chnget:i("filter1keytrack1"), chnget:i("filter1mode2"), chnget:i("filter1cut2"), chnget:i("filter1res2"), chnget:i("filter1keytrack2"), chnget:i("filter1osc1"), chnget:i("filter1osc2"), chnget:i("filter1osc3"), chnget:i("filter1osc4")
    fprints gSFileName, "%f %f %f %f %f %f %f %f %f %f %f %f ", chnget:i("filter2mode1"), chnget:i("filter2cut1"), chnget:i("filter2res1"), chnget:i("filter2keytrack1"), chnget:i("filter2mode2"), chnget:i("filter2cut2"), chnget:i("filter2res2"), chnget:i("filter2keytrack2"), chnget:i("filter2osc1"), chnget:i("filter2osc2"), chnget:i("filter2osc3"), chnget:i("filter2osc4")
